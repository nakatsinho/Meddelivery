<header class="main-header">
    ...
    <a href="{{ url('/admin') }}" class="logo">
      ...
      <!-- logo para  mobile devices -->
      <span class="logo-lg"><b>Me</b>Delivery</span>
    </a>
        ...
        @elseif (!Auth::guest())
			...
			<li class="dropdown messages-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">Voçe tem 4 mensagens</li>
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="./images/itcdevz.png" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Equipe de Suporte
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">Voçe tem 10 notificaçoes</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <li>
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">Voçe tem 9 tarefas</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <li>
