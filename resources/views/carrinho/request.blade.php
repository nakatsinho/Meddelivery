    ...
    <div class="navbar-brand">
        <span class="navbar-logo">
            <a href="https://meddelivery.co.mz">
                <img src="url('meddelivery.co.mz/img/logo.png')" alt="Meddelivery" title="Meddelivery" style="height: 4.2rem;">
            </a>
        </span>
...
<div class="col-lg-6">
    ...
    <ul>
        ...
        <li>Forma de Pagamento: {{$f_pay}}</li>
    ...
    <strong style="color:red">
        <p style="color:green">
            <h3>{{$user}}</h3> Seja Bem-Vindo Sempre, a <u>Sua Farmacia Online.</u>
        </p>
    </strong>
    <br><br>Em caso de dúvidas não hesite em pedir esclarecimentos a nossa equipe técnica através de <a href="http://meddelivery.co.mz">support@meddelivery.co.mz</a> ou pelo WhatsApp <a href="https://wa.me/+258845248888">+258 845248888</a>.
    </p>

    <h4>Melhores cumprimentos, <b>Meddelivery, LDA</b></h4>
</div>